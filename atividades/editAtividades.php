...
if (empty($dados['id'])) {
    ...
    $query_atividades = "UPDATE atividades SET ord=:ord, produto=:produto, quantidade=:quantidade, data=:data, hora=:hora, solicitante_cliente=:solicitante_cliente, documento=:documento, elaborado_por=:elaborado_por WHERE id=:id";
    ...
    $edit_atividades->bindParam(':hora', $dados['hora']);
    $edit_atividades->bindParam(':solicitante_cliente', $dados['solicitante_cliente']);
